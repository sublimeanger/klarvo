  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <Label>Primary purpose category</Label>
        <Select
      ...
      <div className="space-y-2">
        <Label htmlFor="workflow_description">Describe the workflow it's used in</Label>
        <Textarea
      ...
      {data.human_involvement && data.human_involvement !== "hootl" && (
        <div className="space-y-2">
          <Label htmlFor="override_capability">Who can override outputs?</Label>
          <Textarea
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div className="space-y-2">
          <Label htmlFor="impact_scale">Scale of impact (people/month)</Label>
          <Input
            id="impact_scale"
            type="number"
