  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="rounded-lg border bg-muted/50 p-3 sm:p-4 flex gap-2 sm:gap-3">
        <Scale className="h-4 w-4 sm:h-5 sm:w-5 text-muted-foreground shrink-0 mt-0.5" />
        <div>
          <p className="text-xs sm:text-sm font-medium">FRIA Trigger Check</p>
      ...
      <div className="rounded-lg border p-3 sm:p-4">
        <div className="flex justify-between items-center">
          <span className="text-xs sm:text-sm font-medium">FRIA trigger conditions met?</span>
          <span className={`text-xs sm:text-sm font-medium ${friaRequired ? "text-warning" : "text-muted-foreground"}`}>
            {friaRequired ? "Yes" : "No"}
          </span>
        </div>
