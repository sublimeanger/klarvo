  ...
  return (
    <div className="space-y-6">
      <div className="rounded-lg border bg-muted/50 p-4 flex gap-3">
        ...
        <div>
          <p className="text-sm font-medium">Workplace-Specific Obligations</p>
      ...
      <div className="rounded-lg border p-4">
        <div className="flex justify-between items-center">
          <span className="text-sm font-medium">Used in workplace context?</span>
          <span className={`text-sm font-medium ${hasWorkplaceImpact ? "text-warning" : "text-muted-foreground"}`}>
